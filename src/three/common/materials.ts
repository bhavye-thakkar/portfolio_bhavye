import { MeshBasicMaterial, ShaderMaterial, Vector2 } from "three";
...
export const getShadowMaterial = (): ShaderMaterial => {
  ...
  shadowMaterial = new ShaderMaterial({
    ...
    uniforms: {
      ...
      // inert unless the contact scene's goodbye walk moves the figure shadow
      uFigureFrom: { value: new Vector2() },
      uFigureBlend: { value: 0 },
      uFigureRadius: { value: 1 },
    },
  });
