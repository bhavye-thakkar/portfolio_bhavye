...
const updatePosition = () => {
  ...
  // The Experience panels ride the same projection after About has scrolled
  // out, so the stage check covers both scenes.
  const onExperienceStage = sceneWeights.experience > 0;
  if (!onExperienceStage) {
