...
const classNames = computed(() => {
  return {
    header: true,
    // The Experience story page sits on the dark 3D stage, so the header keeps
    // its dark treatment there regardless of where the frozen home page scrolled to.
    "header-dark": isDarkTheme.value || experienceId.value !== null,
